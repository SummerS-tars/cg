...
> **参考来源：** Week 7-9 课程记录；课件06-Lecture07-2026；课件07-Lecture08-2025。  
> raw batch: `visual-explain-fragment-shading-pipeline`、`concept-breakdown-shader-data-flow`；图谱：`knowledge-graph.md`
...
> **参考来源：** Week 7-9 课程记录；课件06-Lecture07-2026；课件07-Lecture08-2025。  
> raw batch: `visual-explain-fragment-shading-pipeline`
...
> **参考来源：** Week 7-8 课程记录；课件06-Lecture07-2026；论文-Improved Illumination Model-CACM1980。  
> raw batch: `deep-dive-phong-blinn-lighting-example`、`concept-breakdown-local-shading-phong`、`source-skeleton-improved-illumination`
...
> **参考来源：** Week 7-8 课程记录；课件06-Lecture07-2026；论文-Improved Illumination Model-CACM1980。  
> raw batch: `deep-dive-microfacet-brdf-visual`、`concept-breakdown-microfacet-brdf`、`slide-skeleton-lecture07`
...
> **参考来源：** Week 8 课程记录；课件06-Lecture07-2026。  
> raw batch: `compare-shading-interpolation-methods`、`concept-breakdown-shading-interpolation`
...
> **参考来源：** Week 9 课程记录；课件07-Lecture08-2025。  
> raw batch: `concept-breakdown-texture-mapping-basics`、`examples-texture-uv-filtering-applications`、`slide-skeleton-lecture08`
...
> **参考来源：** Week 9 课程记录；课件07-Lecture08-2025。  
> raw batch: `concept-breakdown-texture-filtering-applications`、`examples-texture-uv-filtering-applications`
