...
> **参考 raw**：`overview-skeleton`、`notes-skeleton-week15`、`notes-skeleton-week16`、`source-boundary-week16-project-rubric`。
...
> **参考 raw**：`concept-breakdown-exam-homework-boundary`、`review-map-final-exam-p1-p6`。
...
> **参考 raw**：`concept-breakdown-alpha-color-display`、`examples-alpha-blending-exam`。
...
> **参考 raw**：`concept-breakdown-curves-surfaces`、`deep-dive-curves-nurbs-continuity`。
...
> **参考 raw**：`concept-breakdown-pipeline-programmable-api`、`visual-explain-pipeline-mvp-shader`。
...
> **参考 raw**：`concept-breakdown-gpu-driven-rendering`、`compare-traditional-gpu-driven-pipeline`。
...
> **参考 raw**：`concept-breakdown-raytracing-review`；P6 指南 `guides/CG-Week12-14-学习指南.md`。
...
> **参考 raw**：`concept-breakdown-vr-spatial-intelligence`、`visual-explain-vr-spatial-ai`。
