...
用法（仓库根目录）:
  ...
  python .cursor/skills/cg-course-notebooklm/scripts/nlm-collect.py ... --resume notebooklm-raw/<module>/runs/latest
  python .cursor/skills/cg-course-notebooklm/scripts/nlm-collect.py merge-runs <src_run> <dst_run>
